...
function (_React$Component) {
  _inherits(theFLIXdbApp, _React$Component);

  function theFLIXdbApp() {
    _classCallCheck(this, theFLIXdbApp);

    return _possibleConstructorReturn(this, _getPrototypeOf(theFLIXdbApp).apply(this, arguments));
  }

  _createClass(theFLIXdbApp, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "the-flix-db"
...
_reactDom.default.render(_react.default.createElement(theFLIXdbApp), container);
