  ...
  const apiDocsRepository = (function() {
    ...
    const repository = [
      ...
      },
      {
        ...
        method: 'GET',
        request: '-',
        response: 'A text message of the description of the genre requested',
      },
      {
        ...
        method: 'GET',
        request: '-',
        response: 'A JSON object containing data of the director requested (bio, birth year, death year)',
      },
      {
      ...
      },
      {
        ...
        method: 'POST',
        request: '-',
        response: 'A message saying the movie has been added',
      },
      {
